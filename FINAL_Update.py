            ...
            if len(indata) == countValue:
                ...
                for item in indata:
                    ...
                    if(item.find('fire')) != -1:
                        fire = item[5:]
                        if(fire == '0'):
                            stringDetect = 'Detect Fire'
                        elif(fire == '1'):
                            stringDetect = 'Not Detected Fire'
                        print('fire: ', stringDetect)
                        aio.send(Fire.key, stringDetect)

                    if(item.find('PIR')) != -1:
                        Pir = item[5:]
                        if(Pir == '1'):
                            PIRDetect = 'Detect Human'
                        elif(Pir == '0'):
                            PIRDetect = 'Not Detected Human'
                        print('PIR: ', PIRDetect)
                        aio.send(PIR.key, PIRDetect)
